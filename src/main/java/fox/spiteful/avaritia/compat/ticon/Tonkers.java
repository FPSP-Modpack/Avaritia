...
public class Tonkers {
    ...
    public static void buildstruct() {
         ...
         * ItemStack(TinkerTools.patternOutputs[m], 1, neutroniumId));
         * }
         * for (int m = 0; m < TinkerWeaponry.patternOutputs.length; m++) {
         * TConstructRegistry.addPartMapping(TinkerWeaponry.woodPattern, m, neutroniumId, new
         * ItemStack(TinkerWeaponry.patternOutputs[m], 1, neutroniumId));
         * }
