    ...
    public static void compatify() {
        ...
        if (ae2) {
            try {
                ...
                // 16m cell
                Grinder.catalyst.getInput()
                    .add(new ItemStack(resource, 1, 60));

                // Singularity
                Grinder.catalyst.getInput()
                    .add(new ItemStack(resource, 1, 47));
        ...
        if (am2) {
            try {
                ...
                Grinder.catalyst.getInput()
                    .add(new ItemStack(essence, 1, 10));
                Grinder.catalyst.getInput()
                    .add(new ItemStack(gem, 1, 6));
            } catch (Throwable e) {
        ...
        if (Loader.isModLoaded("witchery") && Config.witch) {
            try {
                ...
                Grinder.catalyst.getInput()
                    .add(new ItemStack(ingredient, 1, 150));
