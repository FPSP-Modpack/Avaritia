...
public class Lucrum {
    ...
    public static void abracadabra() throws Compat.ItemNotFoundException {
        ...
        Grinder.catalyst.getInput()
            .add(new ItemStack(LudicrousItems.bigPearl));
        ...
        ThaumcraftApi.registerObjectTag(
            ...
            new AspectList().add(ULTRA_DEATH, 2)
                .add(Aspect.METAL, 12)
        ...
        ThaumcraftApi.registerObjectTag(
            ...
            new AspectList().add(ULTRA_DEATH, 16)
        ...
        ThaumcraftApi.registerObjectTag(
            ...
            new AspectList().add(ULTRA_DEATH, 3)
                .add(Aspect.METAL, 100));
        ThaumcraftApi.registerObjectTag(
        ...
        ThaumcraftApi.registerObjectTag(
            ...
            new AspectList().add(ULTRA_DEATH, 60)
        ...
        (new LudicrousResearchItem(
            "BIG_PEARL",
            "ELDRITCH",
            (new AspectList()).add(ULTRA_DEATH, 8)
                .add(Aspect.MAGIC, 16),
            -1,
            8,
            5,
        ...
        (new LudicrousResearchItem(
            ...
            new ItemStack(LudicrousItems.akashic_record)))
                ...
                .setParents(new String[] { "BIG_PEARL" })
                .setConcealed()
                .setSecondary()
                .registerResearchItem();
        ...
        if (Loader.isModLoaded("ThaumicTinkerer")) {
            try {
                ...
                if (kami) {
                    ...
                    Grinder.catalyst.getInput()
                        .add(new ItemStack(kamiResource, 1, 11978));
                }
            } catch (Exception e) {
