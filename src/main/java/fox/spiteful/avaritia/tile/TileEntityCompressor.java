...
public class TileEntityCompressor extends TileLudicrous implements ISidedInventory {
    ...
    public void updateEntity() {
        ...
        if (input != null && (processing == null || progress < target)) {
            if (CompressorManager.getOutput(input) != null && (output == null || CompressorManager.getOutput(input)
                .isItemEqual(output))) {
                if (processing == null) {
                ...
                if (CompressorManager.getOutput(input)
                    .isItemEqual(processing)) {
    ...
    public boolean isItemValidForSlot(int slot, ItemStack stack) {
        ...
        if (slot == 0) {
            ...
            if (CompressorManager.getOutput(stack)
                .isItemEqual(processing)) return true;
        }
        return false;
    }
