    ...
    public static void configurate(File file) {
        ...
        try {
            ...
            fractured = conf
                ...
                .getBoolean(false);
            fast = conf
                .get("general", "Gotta Go Fast", fast, "Disable if the Infinity Boots' speed boost is too ridiculous")
                .getBoolean(true);
            ...
            thaumic = conf.get("compatibility", "Thaumcraft", true)
                .getBoolean(true);
            sc2 = conf.get("compatibility", "Steve's Carts 2", true)
                .getBoolean(true);
            ae2 = conf.get("compatibility", "Applied Energistics 2", true)
                .getBoolean(true);
            exu = conf.get("compatibility", "Extra Utilities", true)
                .getBoolean(true);
            ic2 = conf.get("compatibility", "Industrialcraft 2 Experimental", true)
                .getBoolean(true);
            gt = conf.get("compatibility", "Gregtech 5", true)
                .getBoolean(true);
            botan = conf.get("compatibility", "Botania", true)
                .getBoolean(true);
            blood = conf.get("compatibility", "Blood Magic", true)
                .getBoolean(true);
            lolDargon = conf.get("compatibility", "Draconic Evolution", true)
                .getBoolean(true);
            bigReactors = conf.get("compatibility", "Big Reactors", true)
                .getBoolean(true);
            ticon = conf.get("compatibility", "Tinkers Construct", true)
                .getBoolean(true);
            pe = conf.get("compatibility", "Project E", true)
                .getBoolean(true);
            mfr = conf.get("compatibility", "MineFactory Reloaded", true)
                .getBoolean(true);
            twilight = conf.get("compatibility", "Twilight Forest", true)
                .getBoolean(true);
            magicrops = conf.get("compatibility", "Magical Crops", true)
                .getBoolean(true);
            am2 = conf.get("compatibility", "Ars Magica 2", true)
                .getBoolean(true);
            te = conf.get("compatibility", "Thermal Expansion", true)
                .getBoolean(true);
            numanuma = conf.get("compatibility", "Pneumaticraft", true)
                .getBoolean(true);
            metallurgy = conf.get("compatibility", "Metallurgy", true)
                .getBoolean(true);
            enderio = conf.get("compatibility", "EnderIO", true)
                .getBoolean(true);
            forestry = conf.get("compatibility", "Forestry", true)
                .getBoolean(true);
            bees = conf.get("compatibility", "Forestry Bees", false)
                .getBoolean(false);
            ee3 = conf.get("compatibility", "Equivalent Exchange 3", true)
                .getBoolean(true);
            extracells = conf.get("compatibility", "Extra Cells", true)
                .getBoolean(true);
            witch = conf.get("compatibility", "Witchery", true)
                .getBoolean(true);
            rotisserie = conf.get("compatibility", "Rotarycraft", true)
                .getBoolean(true);

            conf.addCustomCategoryComment(
                "materials",
                "Disable to stop using that material in recipes. Useful if a mod adds unobtainable placeholder ores.");
            copper = conf.get("materials", "Copper", true)
                .getBoolean(true);
            tin = conf.get("materials", "Tin", true)
                .getBoolean(true);
            silver = conf.get("materials", "Silver", true)
                .getBoolean(true);
            lead = conf.get("materials", "Lead", true)
                .getBoolean(true);
            nickel = conf.get("materials", "Nickel/Ferrous", true)
                .getBoolean(true);
            steel = conf.get("materials", "Steel", true)
                .getBoolean(true);
            ultimateBalance = conf.get("materials", "Clay", true)
                .getBoolean(true);
